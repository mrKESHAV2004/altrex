...
const AnimatedCard = ({ project }) => {
  ...
  const DesktopCard = () => (
    ...
    >
      <div className="relative w-full h-full overflow-hidden rounded-2xl shadow-lg transition-all duration-700 ease-in hover:-translate-y-2 hover:shadow-xl bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        {/* Main Card Content */}
        <div className="absolute w-full h-full bg-transparent flex flex-col">
          {/* Image Container */}
          ...
          <div className={`absolute top-4 right-0 bg-white/10 backdrop-blur-md px-4 py-2 rounded-l-full transition-all duration-700 ease-in
          ...
          <div className="flex-1 p-6 flex flex-col text-white">
            ...
            <div className="space-y-3 mb-4">
              <div className="w-full h-2 bg-gray-700 rounded-full overflow-hidden">
                <div 
                  className="h-full bg-purple-400 transition-all duration-1000 ease-in"
                  style={{ 
            ...
            <div className="mt-auto">
              <button 
                ...
                className="w-full bg-purple-600 text-white py-3 rounded-lg transition-all duration-300 hover:scale-[1.02] hover:shadow-md active:scale-100 focus:outline-none focus:ring-2 focus:ring-purple-400 focus:ring-offset-2"
  ...
  const MobileCard = () => (
    <div className="w-full max-w-sm mx-auto bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 rounded-xl shadow-md overflow-hidden h-[600px]" role="article" aria-label={`Project: ${project.title}`}>
      ...
      {/* Content */}
      <div className="p-6 space-y-6 flex flex-col h-[calc(600px-320px)] text-white">
        ...
        <button 
          onClick={handleBackProject}
          className="w-full bg-purple-600 text-white py-4 rounded-lg flex items-center justify-center space-x-2 active:scale-98 transition-all duration-300 ease-in hover:bg-purple-500 mt-auto"
        >
